<?php
	...
	function verifyConexion(){
	    ...
	    if( $this->conexion->connect_errno != '0' ){
	      ...
	      if ($this->conexion->connect_errno == "202" ){
  ...
  function actualizarRegistro($tabla, $data, $condicion){
    ...
    $sql = 'UPDATE '.$tabla.' SET fecha_inicio = '.$data['fecha_inicio'].', fecha_fin = '.$data['fecha_finalizacion'].' WHERE '.$condicion.'; ' ;
